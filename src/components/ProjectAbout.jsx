  ...
  return (
    <>
      <motion.div variants={textVariant()}>
        ...
        <h2 className="text-center xs:text-[30px] text-[20px] lg:leading-[50px] font-medium">Passionate Software Developer · Avid Programmer · Funny Fella</h2>
      </motion.div>
      <div className="flex md:flex-row flex-col w-full">
        <motion.img variants={fadeIn("", "", 0.1, 1)} src={mePicture} className="md:w-1/4 w-full border-white border-2 mt-6 rounded-3xl object-cover shadow-card mx-auto" alt=""/>
      </div>
    </>
  )
}
