    ...
    <>
      ...
      <div className="flex md:flex-row flex-col mt-4 w-full">
        ...
        <motion.p variants={fadeIn("", "", 0.1, 1)} className="text-secondary text-[17px] max-w-3xl leading-[30px] md:w-2/3 w-full md:mt-0 mt-4 md:ml-10">
          I am currently a student at the <span className="font-semibold">National University of Singapore</span>, studying 
          <span className="font-semibold"> Computer Science</span>. I have a passion for software development, coding, solving 
          ...
          my dreams of being a full-time <span className="font-semibold"> Software Engineer</span>. Away from the computer, 
          I love Formula One and sports like bowling and rock climbing.
        </motion.p>
      </div>
